                    ...
                    <div class="animate-fade-in">
                        ...
                        <div class="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-6">
                            <div class="bg-white/10 backdrop-blur-sm p-6 rounded-xl">
                                <div class="text-3xl font-bold">SAR 25,000</div>
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        ...
                        <div class="module-card bg-gradient-to-br from-purple-50 to-purple-100 p-8 rounded-2xl border border-purple-200 hover:shadow-xl transition-all duration-300">
                            ...
                            <ul class="space-y-3">
                                ...
                                <li class="flex items-center"><i class="fas fa-check text-green-500 mr-3"></i>
                                    <span>Multi-branch management</span></li>
                                <li class="flex items-center"><i class="fas fa-check text-green-500 mr-3"></i>
                ...
                <div class="container mx-auto px-4">
                    ...
                    <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        ...
                        <div class="pricing-card bg-white p-8 rounded-2xl shadow-xl border-4 border-maysan-blue relative">
                            ...
                            <div class="text-center mb-8">
                                ...
                                <div class="text-5xl font-bold text-maysan-blue mb-2">25,000</div>
                                <div class="text-gray-600">SAR</div>
                            ...
                            <ul class="space-y-4 mb-8">
                                ...
                                <li class="flex items-start">
                                    <i class="fas fa-check text-green-500 mr-3 mt-1"></i>
                                    <span>Multi-branch support & detailed reporting</span>
                                </li>
                                <li class="flex items-start">
                                    <i class="fas fa-check text-green-500 mr-3 mt-1"></i>
                    ...
                    <div class="text-center mt-12 p-8 bg-white rounded-2xl shadow-xl max-w-3xl mx-auto">
                        ...
                        <div class="flex items-center justify-center space-x-4 mb-6">
                            <div class="text-3xl font-bold text-maysan-blue">SAR 25,000</div>
                            <div class="text-2xl">+</div>
                            <div class="text-3xl font-bold text-orange-500">SAR 15-20K</div>
                            <div class="text-2xl">=</div>
                            <div class="text-4xl font-bold text-green-600">SAR 40-45K</div>
                        </div>
                    ...
                    <div class="max-w-4xl mx-auto">
                        ...
                        <div class="bg-maysan-blue/10 p-8 rounded-2xl mt-12">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    <div class="text-3xl font-bold text-maysan-blue mb-2">8-12 weeks</div>
                                    <div class="text-maysan-gray">Core Package (Website + CRM + Clinic Management)</div>
                                </div>
                                <div>
                                    <div class="text-3xl font-bold text-orange-500 mb-2">11-16 weeks</div>
                                    <div class="text-maysan-gray">Complete Solution (Including Inventory Management)</div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="space-y-6">
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="opacity-90">+966 XX XXX XXXX</div>
                                    </div>
                                </div>
                                ...
                                <div class="flex items-center space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <div class="opacity-90">ahmed@maysan-it.com</div>
                                    </div>
                                </div>
                            ...
                            <form id="contact-form" class="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select class="w-full p-4 rounded-lg text-gray-900 border-0 focus:ring-4 focus:ring-white/30">
                                        <option>Core Digital Package (SAR 25,000)</option>
                                        <option>Complete Solution (SAR 40-45K)</option>
